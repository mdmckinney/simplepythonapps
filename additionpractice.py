...
#Opening
print("\n\n\n\t\tADDITION PRACTICE\n\n\n")
print("Let's do some addition problems.")
...
while True:
	...
	if user_input != 'quit' and user_input != 'qui' and user_input != 'qu' and user_input != 'q':		
		...
		if user_input == first_number + second_number:
			...
			# Play again?		  			
			playagain = input("\nDo another addition problem? (Yes/No): ")
		...
		#User input a zero.		
			...
			print("You can't get a zero by adding two non-zero numbers. "
				"Try again. ")
			continue
		...
		#User input a negative number.		
			...
			print("You can't get a negative number by adding two "
				"non-negative numbers. Try again. ")
			continue			
